...
('CVE-2014-1739', '[media] media-device: fix infoleak in ioctl media_enum_entities()', 3.04),
...
('CVE-2014-4655', 'UPSTREAM: ALSA: control: Fix replacing user controls', 3.04),
...
('CVE-2014-9922', 'BACKPORT: fs: limit filesystem stacking depth', 3.04),
...
('CVE-2015-8964', 'BACKPORT: tty: Prevent ldisc drivers from re-using stale tty fields', 3.04),
...
('CVE-2016-0821', 'UPSTREAM: include/linux/poison.h: fix LIST_POISON{1,2} offset', 3.04),
('CVE-2016-0823', 'pagemap: do not leak physical addresses to non-privileged userspace', 3.04),
('CVE-2016-10044', 'BACKPORT: aio: mark AIO pseudo-fs noexec', 3.04),
...
('CVE-2016-3843', 'BACKPORT: perf tools: Document the perf sysctls', 3.04),
...
('CVE-2016-6756', 'BACKPORT: msm: camera: Avoid exposing kernel addresses', 3.04),
('CVE-2016-6757', 'msm: mdss: hide kernel addresses from unprevileged users', 3.04),
('CVE-2016-6786', 'BACKPORT: perf: Fix event->ctx locking', 3.04),
...
('CVE-2016-7097', 'BACKPORT: posix_acl: Clear SGID bit when setting file permissions', 3.04),
...
('CVE-2016-7917', 'BACKPORT: netfilter: nfnetlink: correctly validate length of batch messages', 3.18),
...
('CVE-2016-8403', 'usb: diag: change %p to %pK in debug messages', 3.04),
...
('CVE-2016-8407', 'usb: Avoid exposing kernel addresses', 3.04),
...
('CVE-2016-9120', 'BACKPORT: ion: fix a race condition in the ion driver', 3.04),
...
('CVE-2017-0510', 'BACKPORT: fiq_debugger: restrict access to critical commands.', 3.04),
...
('CVE-2017-0750', 'BACKPORT: f2fs: sanity check log_blocks_per_seg', 3.04),
...
('CVE-2017-10662', 'UPSTREAM: f2fs: sanity check segment count', 3.04),
('CVE-2017-10663', 'BACKPORT: f2fs: sanity check checkpoint segno and blkoff', 3.04),
...
('CVE-2017-6214', 'BACKPORT: tcp: avoid infinite loop in tcp_splice_read()', 3.04),
...
('CVE-2017-8264', 'BACKPORT: msm: camera: Add regulator enable and disable independent of CSID', 3.04),
